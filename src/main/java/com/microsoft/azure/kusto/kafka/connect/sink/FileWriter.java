...
public class FileWriter implements Closeable {
    ...
    private JsonRecordWriterProvider jsonRecordWriterProvider = new JsonRecordWriterProvider();
    ...
    public FileWriter(String basePath,
        ...
        if(getFilePath.get().contains("json")) {
            recordWriterProvider = new JsonRecordWriterProvider();
        }
        if(getFilePath.get().contains("orc")){
            recordWriterProvider = new OrcRecordWriterProvider();
        }
    ...
    public void openFile() throws IOException {
        ...
        recordWriter = parquetRecordWriterProvider.getRecordWriter(kustoConfig,currentFile.path,null);
        }
            ...
            recordWriter = orcRecordWriterProvider.getRecordWriter(kustoConfig, currentFile.path, null);
        } else {
        outputStream = shouldCompressData ? new GZIPOutputStream(countingStream) : countingStream;
        }
